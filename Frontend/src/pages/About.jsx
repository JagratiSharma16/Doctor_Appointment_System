...
const About = () => {
  return (
    <div >
      ...
      <div className = 'my-10 flex flex-col justify-center md:flex-row gap-12 2xl:mx-20   xl:mx-10 xl:pl-30 2xl:pl-20'>
      ...
      <div className='flex flex-col md:flex-row mb-20 2xl:mx-20 xl:mx-5 pl-20 xl:pr-20 '>
