...
const Contact = () => {
  return (
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm 2xl:text-xl'>
        <img className='w-full md:max-w-[360px] 2xl:max-w-[400px]' src = {assets .contact_image} alt="" />
